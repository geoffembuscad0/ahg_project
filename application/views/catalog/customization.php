<?php echo $head; ?>
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <li><a id="clearCustomization" class="button" onclick="clearcanvas()" href="#restart">Restart</a></li>
            </ul>
...
<div class="large-12 columns">
<h1 class="text-left"><?php echo $header_text;?></h1>
<?php echo form_button('submit_customize', 'Submit Customized Product', 'id="submitCustomization" class="button" style="float:rightl;"');?>
<?php echo form_hidden('product_no', $product_info[0]['product_no']);?>
</div>
</div>
...
context.clearRect(0, 0, canvas.width, canvas.height);
$(".draggable").css({
"left":0,// $(".draggable").data('originalLeft'),
"top":0// $(".draggable").data('origionalTop')
});
}
function saveImg(){
var oCanvas = document.getElementById("theCob");
...
// makes items draggable [IMPORTANT ERROR FIX]]
$(".draggable").draggable({
